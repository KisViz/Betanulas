...
function Calculator() {
    ...
    //         mit szeretném ha futtatna, és mikor szeretném ha lefutna (most ha a kettő közül vallamelyik változik)
    useEffect(() => {
    ...
    function handleSubmit(e) {
        e.preventDefault() //ez meggatolja a bongeszo alap viselkedeset
